...
const rawMunicipalities = require(`../locales/${config.COUNTRY_CODE}-municipalities.json`);
const postalCodesWithCoordinates = require(`../locales/${config.COUNTRY_CODE}-postalCodeCoordinates.json`);
