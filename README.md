...
- Add a iamge that will used when sharing the url in social media in `/static/{COUNTRY_CODE}/social-media.png`. @amritnagi or @adriaanvanrossum can create one if you provide them with text.
